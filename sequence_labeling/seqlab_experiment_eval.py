...
#from hf_skelarn_wrapper import SklearnTransformerBase
...
def build_eval_seqlab_model(lang):
    ...
    #model = load_or_build_seqlab_fulltrain_model(lang, model_name, model_label=model_label)
    hf_model_id = 'bert-base-cased' if lang == 'en' else 'dccuchile/bert-base-spanish-wwm-cased'
    model = load_or_build_seqlab_fulltrain_model(lang, hf_model_id, model_label='bert-base')
...
if __name__ == '__main__':
    ...
    #]
    #build_eval_seqlab_models('en', models_to_evaluate)
